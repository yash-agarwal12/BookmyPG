      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="home_pgowner.php">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="pg_master" >
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="view-pg_master.php">View PG Details</a></li> 
          ...
          <li class="nav-item">
              ...
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title">My PG Images</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="pgimages" >
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="display-pgimages.php">View PG Images</a></li> 
                <li class="nav-item"> <a class="nav-link" href="addimage.php">Add PG Images</a></li> 
              </ul>
            </div>          
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="changepass.php" aria-expanded="false" aria-controls="error">
              <i class="icon-archive menu-icon"></i>
              <span class="menu-title">Change Password</span>
            </a>
          </li>
<li class="nav-item">
            <a class="nav-link" href="logout.php" aria-expanded="false" aria-controls="feedback">
