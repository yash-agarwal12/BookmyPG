...
Document                          </th>
                    ...
                    <th style="font-size:20px">
                      ...
                      $selectq=mysqli_query($connection,"select * from tbl_pg_master  where pg_id ='{$_SESSION['pg_id']}'")or die(mysqli_error($connection));
                          ...
                          while($arearow = mysqli_fetch_array($selectq))
                          {
                              ...
                              echo "<td>{$arearow['pg_phonenumber']}</td>";
                                                           echo "<td><a  href='../admin/pgdocs/{$arearow['pg_registrationdocs']}'>Registration</a> | <a  href='../admin/pgdocs/{$arearow['pg_idproof']}'>ID Proof</a> | </td>";

                              echo "<td> <a href='edit-pg_master.php?eid={$arearow['pg_id']}'><img src='myimages/eye.png'>"
                              . "</a> | <a href='view-pg_master.php?did={$arearow['pg_id']}'><img src='myimages/delete.png'></a>";
