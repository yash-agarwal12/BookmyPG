<?php
      ...
      {
          header("location: display-pg_master.php");
      }
...
FROM
    ...
    INNER JOIN `tbl_area` 
      ...
      if($_POST)
      {
          ...
          $pg__name=mysqli_real_escape_string($connection,$_POST['pg__name']);
          ...
          $pg_image_id=mysqli_real_escape_string($connection,$_POST['pg_image_id']);
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_ownername'] ?>" name="pg_ownername" readonly required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['category_name'] ?>" name="category_name" readonly  required/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_email'] ?>" name="pg_email" readonly  required/>
                          </div>
                        </div>
                         </div>
                         <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pgowner_gender'] ?>" name="pgowner_gender" readonly  required/>
                          </div>
                        </div>
                      </div>
                         <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_password'] ?>" name="pg_password" readonly required/>
                          </div>
                        </div>
                         </div>
                         <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_phonenumber'] ?>" name="pg_phonenumber" readonly  required/>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_address'] ?>" name="pg_address" readonly required/>
                          </div>
                        </div>
                      </div>
                         <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_registrationdocs'] ?>" name="pg_registrationdocs" readonly required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pgowner_dob'] ?>" name="pgowner_dob" readonly  required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['area_name'] ?>" name="area_name" readonly  required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_depositamount'] ?>" name="pg_depositamount" readonly  required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_monthlycharge'] ?>" name="pg_monthlycharge" readonly  required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_isgirlsboys'] ?>" name="pg_isgirlsboys" readonly required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_operatingsince'] ?>" name="pg_operatingsince" readonly  required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_idproof'] ?>" name="pg_idproof" readonly  required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_sharing'] ?>" name="pg_sharing" readonly  required/>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?php echo $selectrow['pg_isverified'] ?>" name="pg_isverified" readonly  required/>
                          </div>
                        </div>
                      </div>
